...
function db_connection_failed(\PDOException $e): void {
    ...
    $hints = [
        ...
        1044 => ['کاربر دسترسی ندارد، یا پایگاه داده با این نام نیست',
                 'دو چیز را بررسی کن: نام دقیق پایگاه داده (بزرگی و کوچکی حروف مهم است)، و اینکه کاربر در پنل هاست به آن وصل شده باشد.'],
